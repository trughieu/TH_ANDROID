...
public class AddressFragment extends Fragment {
    TextInputEditText txtAddress, txtMobile;
    Button btnNextAddress;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnNextAddress = view.findViewById(R.id.btnNextAddress);
        btnNextAddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (txtMobile.getText().toString().isEmpty()) {
                    txtMobile.setError("Không được bỏ trống");
                    return;
                }
//        btnNextAddress.setOnClickListener(v -> {
//            if (txtAddress.getText().toString().isEmpty()) {
//                txtAddress.setError("Không được bỏ trống");
//                return;
//
...
//
//            }
                LatLng latLng = LocationServiceTask.getLatLngFromAddress(getContext(),
                        txtAddress.getText().toString());
                Bundle bundle = new Bundle();
                bundle.putString("address", txtAddress.getText().toString());
                bundle.putDouble("latitude", latLng.latitude);
                bundle.putDouble("longitude", latLng.longitude);
                bundle.putString("mobile", txtMobile.getText().toString());
                bundle.putString("firstname", getArguments().getString("firstname"));
                bundle.putString("lastname", getArguments().getString("lastname"));
                navController.navigate(R.id.action_addressFragment_to_userpasswordFragment, bundle);
            }
        });
    }
}
...
//            elsePermissionTask.requestLocationServicePermissions(getActivity());
//        } else {
...
//                && grantResults.length == 2 && grantResults[0] ==
